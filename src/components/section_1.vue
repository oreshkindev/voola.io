...
<template>
  <section>
    <Grid :columns="2">
      ...
      <picture>
        <source media="(max-width: 928px)" srcset="../assets/images/Frame-10692682.png" />
        <source media="(min-width: 928px)" srcset="../assets/images/Frame-110@2x.png" />
